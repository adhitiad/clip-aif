      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center space-y-8">
          ...
          <p className="max-w-2xl mx-auto text-gray-400 text-base md:text-xl animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 px-4">
            Ubah video panjang menjadi konten viral berdurasi pendek dalam
            hitungan detik. Biarkan AI kami bekerja, Anda cukup melihat
            hasilnya.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-500 rounded-full px-8 h-12 text-lg shadow-xl shadow-blue-600/20 group"
              >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/10 bg-white/5 hover:bg-white/10 rounded-full px-8 h-12 text-lg"
            >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
              Supercharge Kreativitasmu
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto text-lg">
              Toolkit lengkap berbasis AI untuk membantu Anda mendominasi media
              sosial.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4 mb-16 px-4">
            <h2 className="text-2xl md:text-5xl font-bold tracking-tight">
              Pilih Paket Kesuksesanmu
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto text-base md:text-lg">
              Dari pemula hingga pro, kami punya paket yang tepat untuk Anda.
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="space-y-4 flex-1">
                  {p.features.map((feat: string, idx: number) => (
                    <div
                      key={idx}
                      className="flex items-start gap-3 text-sm text-gray-400 group-hover:text-gray-300"
                    >
                ...
                <CardFooter>
                  <Link href="/register" className="w-full">
                    <Button
                      className={`w-full h-12 rounded-xl text-lg font-semibold transition-all ${p.popular ? "bg-blue-600 hover:bg-blue-500 shadow-xl shadow-blue-600/10" : "bg-white/5 border border-white/10 hover:bg-white/10"}`}
                    >
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-[2rem] md:rounded-[3rem] p-8 md:p-24 text-center space-y-8 relative overflow-hidden">
            ...
            <p className="text-blue-100 text-lg md:text-xl max-w-xl mx-auto relative z-10 px-4">
              Daftar sekarang dan rasakan kemudahan membuat konten video pendek
              berbasis AI.
            </p>
            <div className="relative z-10 pt-4">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="bg-white text-black hover:bg-gray-100 w-full sm:w-auto px-8 md:px-12 h-14 md:h-16 text-lg md:text-xl font-bold rounded-full shadow-2xl"
                >
      ...
      <footer className="py-12 border-t border-white/5 bg-black">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-gray-500 text-sm">
            © 2026 ClipAIF Inc. All rights reserved.
          </p>
