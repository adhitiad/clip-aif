...
export default function AdminDashboardPage() {
  ...
  const systemAlerts = [
    {
      title: "User Credit Depleted",
      desc: "User 'clip_user_99' has reached 0 credits.",
      level: "warning",
      time: "2m ago",
    },
    {
    ...
    },
    {
      ...
      desc: "Temp models directory reached 12GB.",
      level: "warning",
      time: "30m ago",
    },
    {
      title: "Task Delay",
      desc: "Celery queue length is above threshold (50+).",
      level: "warning",
      time: "45m ago",
    },
    {
      title: "ML Training Completed",
      desc: "Periodic model refresh finished successfully.",
      level: "info",
      time: "2h ago",
    },
    {
      title: "New Enterprise Plan",
      desc: "Corp 'TechFusion' upgraded to Enterprise.",
      level: "info",
      time: "5h ago",
    },
  ];
  ...
  return (
    <div className="p-2 md:p-6 space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Badge
          variant="outline"
          className="border-blue-500/30 text-blue-400 bg-blue-500/5 px-4 py-1.5 rounded-full uppercase tracking-widest font-bold whitespace-nowrap"
        >
          Restricted Access
        </Badge>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="xl:col-span-2 space-y-8">
          <SystemMonitor />
          <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 p-[1px] rounded-2xl">
              ...
              <ScrollArea className="h-[600px]">
                <div className="p-4 space-y-4">
                  {systemAlerts.map((alert, i) => (
                    <div
                      key={i}
                      className="group p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors relative overflow-hidden"
                    >
                      <div
                        className={`absolute left-0 top-0 bottom-0 w-1 ${alert.level === "critical" ? "bg-red-500" : alert.level === "warning" ? "bg-yellow-500" : "bg-blue-500"}`}
                      />
